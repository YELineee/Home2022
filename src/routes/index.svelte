...
<List>
	<Card class="flex flex-col md:flex-row md:justify-between items-center">
		...
		<CardContextBlock>
			<p>
				与具有鲜明科研性质的导师实验室不同，在iOS
				club，没有标准答案，只有不同的见解。虽然自称实验室，但其实我们的性质更像俱乐部，属于different
				thinkers的俱乐部。
			</p>
			<p>
			...
			<p>
				在苹果实验室，我们有丰富的资源支持。无论是深度学习研究、移动应用开发或者任何方向，都能在实验室中获得资源加持。
			</p>
	...
	<Card class="flex flex-col md:flex-row md:justify-between items-center">
		...
		<CardContextBlock>
			<p>
				中南大学苹果实验室欢迎各种形式的合作，详情请咨询目前的学生负责人，请见<a
					class="font-bold"
	...
	<Card class="flex flex-col md:flex-row-reverse md:justify-between items-center">
		...
		<CardContextBlock>
			<p>
				苹果实验室坚持小而精的发展路线，每届只固定招收 8-9
				人，招生对象面向全校。我们没有硬性的招生标准，只希望能够和有着不同想法的你相遇。
			</p>
			<p>
				在每年8月底至9月初，我们会透过本站及各个渠道进行宣传招新。期待你的<a
					class="font-bold"
					href="/joinUs">加入。</a
				>
			</p>
